...
# Title: Top Block
# Generated: Fri Jan 11 13:59:28 2019
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._uisigtype_options = (101, 103, 100, 102, 104, )
        self._uisigtype_labels = ('Sine', 'Square', 'Constant', 'Cosine', 'Triangle', )
        ...
        self._ui_freq_win = RangeWidget(self._ui_freq_range, self.set_ui_freq, "ui_freq", "counter_slider", float)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, uisigtype, ui_freq, 1, 0)
    ...
    def get_ui_freq(self):
        return self.ui_freq

    def set_ui_freq(self, ui_freq):
        self.ui_freq = ui_freq
        self.analog_sig_source_x_0.set_frequency(self.ui_freq)
